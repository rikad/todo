      ...
      <div class="card">
        ...
        <div class="body">
          ...
          <ul class="nav nav-tabs tab-nav-right" role="tablist">
            ...
            <li role="presentation"  class="active"><a href="#">Add Permission</a></li>
          </ul>

          <br>

            @if(isset($data))
              {!! Form::model($data, ['url' => route('permissions.update', $data->id), 'files'=>true,'method'=>'put','class'=>'form-horizontal']) !!}
            @else
              {!! Form::open(['url' => route('permissions.store'), 'method' => 'post','files'=>true, 'class'=>'form-horizontal']) !!}
            @endif
