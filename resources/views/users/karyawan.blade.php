        ...
        <div class="header bg-blue-grey">
          ...
          <ul class="header-dropdown m-r--5">
            <li class="dropdown">
              ...
              @if(\Laratrust::can("create-karyawan"))
...
<script>
  ...
  var showPath = '{{ route("karyawan.show",'') }}';
  ...
  $(function() {
    ...
    $('#users-table').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{!! route('users.index') !!}'+'?type=karyawan',
      columns: [
      ...
      { data: 'id', name: 'id', sortable: false,render: function(data) {
        return '<a href="'+genShowPath(data)+'"><button class="btn btn-success btn-xs">Lihat</button></a> @if(\Laratrust::can("update-karyawan")) <a href="'+genEditPath(data)+'"><button class="btn btn-primary btn-xs">Ubah</button></a>@endif @if(\Laratrust::can("delete-karyawan")) <button onclick="deleteData('+data+')" class="btn btn-danger btn-xs">Hapus</button> @endif';
      }},
      ],
      dom: 'Bfrtip',
      responsive: true,
